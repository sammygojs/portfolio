...
const About = () => {
  return (
    <div id='#about' className='w-full md:h-screen bg-gradient-to-b from-gray-800 to-black text-white'> 
        <div className='max-w-screen-lg px-16 mx-auto flex flex-col justify-center w-full h-full'>
            {/* <div className='pb-8'> */}
